...
void Shader::SetBool(string const &uniform, bool value) {
    glUniform1i(glGetUniformLocation(program_id, uniform.c_str()), (int)value);
}

void Shader::SetInt(string const &uniform, int value) {
    glUniform1i(glGetUniformLocation(program_id, uniform.c_str()), value);
}

void Shader::SetFloat(string const &uniform, float value) {
    glUniform1f(glGetUniformLocation(program_id, uniform.c_str()), value);
}

void Shader::SetFloatMatrix(string const &uniform, float *address) {
    glUniformMatrix4fv(glGetUniformLocation(program_id, uniform.c_str()), 1, GL_FALSE, address);
}